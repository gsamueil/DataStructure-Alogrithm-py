...
def find_missing(list, n):
    sum1 = 100*101/2 #this eqution will help to calc the total number os the list then will make minus from the original summision of the list 
    sum2 = sum(list)
    print(sum1-sum2)#thecompare herw will appear if amy missed happen
